...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    #add test code here
    size_of_side_twenty = volume_of_cube( 20 )
    assert_equal( 8000, size_of_side_twenty)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    #add test code here
    six_volume_of_sphere = volume_of_sphere( 6 )
    assert_equal( 904.778496, six_volume_of_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    #add test code here
    twohundred_and_forty_eight_fahrenheit_to_celsius = fahrenheit_to_celsius( 248 )
    assert_equal(120, twohundred_and_forty_eight_fahrenheit_to_celsius)
  end
